...
with open('olympus-bite-ft/features/routines/components/ClientRoutinesView.tsx', 'r') as f:
    content = f.read()
...
with open('olympus-bite-ft/features/routines/components/ClientRoutinesView.tsx', 'w') as f:
    f.write(content)
