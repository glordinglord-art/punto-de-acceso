  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "ai",
      content:
        "¡Hola! Soy tu asistente de dietas. Dame un objetivo como *'Necesito una cena rápida alta en proteínas'* y usaré el contexto nutricional de este cliente para crear la mejor opción.",
    },
  ]);
    ...
    <div className="flex flex-col h-[500px]">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white rounded-xl px-4 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
          disabled={isLoading}
        />
