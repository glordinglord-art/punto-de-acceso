...
import { ArrowRight, Dumbbell, Flame, CheckCircle2, Target } from "lucide-react";
...
const INJECTED_STYLES = `
  ...
  .bg-grid-theme {
      ...
      background-image: 
          linear-gradient(to right, color-mix(in srgb, var(--color-primary-500) 5%, transparent) 1px, transparent 1px),
          linear-gradient(to bottom, color-mix(in srgb, var(--color-primary-500) 5%, transparent) 1px, transparent 1px);
...
export function CinematicHero({ 
  ...
  ctaDescription = "Únete a la plataforma donde clientes y entrenadores se toman en serio los resultados.",
  className, 
  ...props 
}: CinematicHeroProps) {
    ...
    const ctx = gsap.context(() => {
      ...
      const scrollTl = gsap.timeline({
        scrollTrigger: {
          ...
          start: "top top",
          end: "+=3500", // Reduced from 7000 to make it faster
          pin: true,
          scrub: 1,
          anticipatePin: 1,
        },
  ...
  return (
    ...
    >
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 will-change-transform transform-style-3d">
        <h1 className="text-track gsap-reveal text-3d-matte font-display uppercase text-5xl md:text-7xl lg:text-[6rem] font-bold tracking-tight mb-2">
          {tagline1}
        </h1>
        <h1 className="text-days gsap-reveal text-silver-matte font-display uppercase text-5xl md:text-7xl lg:text-[6rem] font-extrabold tracking-tighter">
          {tagline2}
        </h1>
      </div>
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        <h2 className="text-4xl md:text-6xl lg:text-7xl font-display uppercase font-bold mb-6 tracking-tight text-silver-matte">
          {ctaHeading}
        </h2>
        <p className="text-slate-400 text-lg md:text-xl mb-12 max-w-xl mx-auto font-light leading-relaxed">
          {ctaDescription}
        </p>
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <Link href="/login" className="flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-8 py-4 text-base font-semibold text-white backdrop-blur-md transition-all hover:bg-white/10 hover:-translate-y-1">
            Iniciar sesión
          </Link>
        </div>
      </div>
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                <div
                  ref={mockupRef}
                  className="relative w-[280px] h-[580px] rounded-[3rem] iphone-bezel flex flex-col will-change-transform transform-style-3d bg-slate-950"
                >
                  ...
                  <div className="absolute inset-[7px] bg-slate-950 rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col bg-gradient-to-br from-slate-900 to-slate-950">
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center bg-white/5">
                          <div className="w-10 h-10 rounded-xl bg-orange-500/20 flex items-center justify-center mr-3 border border-orange-400/20">
                            <Flame className="w-4 h-4 text-orange-400 drop-shadow-md" />
                          </div>
                          <div className="flex-1">
                            <div className="text-xs font-semibold text-white">Calorías registradas</div>
                            <div className="text-[10px] text-slate-400 mt-0.5">Te faltan 360 kcal</div>
                          </div>
                        </div>
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center bg-white/5">
                          <div className="w-10 h-10 rounded-xl bg-blue-500/20 flex items-center justify-center mr-3 border border-blue-400/20">
                            <Dumbbell className="w-4 h-4 text-blue-400 drop-shadow-md" />
                          </div>
                          <div className="flex-1">
                            <div className="text-xs font-semibold text-white">Día 4: Pierna</div>
                            <div className="text-[10px] text-slate-400 mt-0.5">Rutina pendiente</div>
                          </div>
                        </div>
                      </div>
